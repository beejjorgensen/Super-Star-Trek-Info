...
46 IF INP(1)=13 THEN 46

REM I don't know what these POKEs do. Something about the TTY?
REM NULL 1 means to print 1 NULL at the end of each line.
REM https://ia800708.us.archive.org/8/items/BASIC-80_MBASIC_Reference_Manual/BASIC-80_MBASIC_Reference_Manual_text.pdf

50 POKE 1229,2:POKE 1237,3:NULL 1
...
170 PRINT"     TYPE IN ILLEGAL DATA (LIKE NEGATIVE NUMEBRS), THAT COMMAND"
...
1130 PRINT"     OPTION 5 = CALACTIC /REGION NAME/ MAP"
1140 PRINT"        THIS OPTION PRINTS THE NAMES OF THE SIXTEEN MAJOR "
1150 PRINT"        GALACTIC REGIONS REFERRED TO IN THE GAME."

REM I don't know what these POKEs do. Something about the TTY?
REM NULL 0 means to print 0 NULLs at the end of each line.
REM https://ia800708.us.archive.org/8/items/BASIC-80_MBASIC_Reference_Manual/BASIC-80_MBASIC_Reference_Manual_text.pdf

1990 POKE 1229,0:POKE 1237,1:NULL 0
2000 PRINT:PRINT:PRINT
2010 PRINT "TURN CASSETTE PLAYER ON AND HIT ANY KEY EXCEPT RETURN"
2020 IF INP(1)=13 THEN 2020
2030 PRINT
2040 PRINT "TURN CASSETTE PLAYER OFF AND "
2050 PRINT "TYPE 'RUN' WHEN COMPUTER PRINTS 'OK'"
