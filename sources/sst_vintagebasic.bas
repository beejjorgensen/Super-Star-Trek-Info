REM From: http://www.vintage-basic.net/bcg/superstartrek.bas
REM 
REM Lines ending with REM -DEV- are known deviations from the published
REM source.
...
170 REM ***
180 REM *** CONVERTED TO MICROSOFT 8 K BASIC 3/16/78 BY JOHN GORDERS REM -DEV-
...
815 REM K3= # KLINGONS  B3= # STARBASES  S3 = # STARS REM -DEV-
...
1100 IFB9<>0THEN1200
1150 IFG(Q1,Q2)<200THENG(Q1,Q2)=G(Q1,Q2)+120:K9=K9+1 REM -DEV-
...
1252 PRINT"   THE GALAXY BEFORE THEY CAN ATTACK FEDERATION HEADQUARTERS" REM -DEV-
1260 PRINT"   ON STARDATE";T0+T9;"  THIS GIVES YOU";T9;"DAYS.  THERE";X0$
1272 PRINT"  ";B9;"STARBASE";X$;" IN THE GALAXY FOR RESUPPLYING YOUR SHIP" REM -DEV-
1280 PRINT:REM PRINT"HIT ANY KEY EXCEPT RETURN WHEN READY TO ACCEPT COMMAND" REM -DEV-
1300 I=RND(1):REM IF INP(1)=13 THEN 1300 REM -DEV-
...
2260 PRINT"  XXX  (TO RESIGN YOUR COMMAND)":PRINT:GOTO 1990 REM -DEV-
...
2550 PRINT"DEFLECTOR CONTROL ROOM ACKNOWLEDGES";S;"UNITS OF ENERGY"  REM -DEV-
...
5840 INPUT "WILL YOU AUTHORIZE THE REPAIR ORDER (Y/N)";A$  REM -DEV-
...
6170 PRINT"DAMAGE CONTROL REPORTS ";G2$;" DAMAGED BY THE HIT'"  REM -DEV-
6200 NEXTI:RETURN
6210 REM END OF GAME
6220 PRINT"IT IS STARDATE";T:GOTO 6270
6240 PRINT:PRINT"THE ENTERPRISE HAS BEEN DESTROYED.  THEN FEDERATION ";  REM -DEV-
...
6360 END
6370 PRINT"CONGRULATION, CAPTAIN!  THEN LAST KLINGON BATTLE CRUISER"  REM -DEV-
6380 PRINT"MENACING THE FDERATION HAS BEEN DESTROYED.":PRINT  REM -DEV-
...
7540 REM INPUT"DO YOU WANT A HARDCOPY? IS THE TTY ON (Y/N)";A$  REM -DEV-
7542 REM IFA$="Y"THENPOKE1229,2:POKE1237,3:NULL1  REM -DEV-
7543 PRINT:PRINT"        ";
...
7850 PRINT:PRINTO1$:NEXTI:PRINT:GOTO1990  REM -DEV-
