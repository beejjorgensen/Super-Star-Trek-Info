rem From https://www.retromagazine.net/super-star-trek-commodore-64-basic-v2/
...
195 rem *** converted to Commodore 64 (40 columns)  
200 rem *** by Francesco Fiorentini on July 2021
205 print chr$(147): poke 53280,0: poke 53281,0:poke 646,7
...
2340 print"'incorrect course data, sir!'":goto1990
...
2430 print"engines won't take warp ";w1;"!'":goto1990
...
2810 ifd1<>1thend1=1:print"damage control report:";print
...
4280 print"show no enemy ships in this quadrant'":goto1990
...
4500 print"no damage to enemy at ";k(i,1);",";k(i,2):goto4670
...
5610 print"federation treasury'-shields unchanged":goto1990
5630 e=e+s-x:s=x:print"deflector control room report:"
5660 print"'shields now at";int(s);"units"
5670 print"per your command.'":goto1990
...
6080 printh;"unit hit on enterprise"
...
6825 nexti:print:printo1$
6830 rem onigoto6850,6900,6960,7020,7070,7120,7180,7240
6850 print"  stardate           ";int(t*10)*.1:rem goto7260
6900 print"  condition           ";c$:rem goto7260
6960 print"  quadrant           ";q1;",";q2:rem goto7260
7020 print"  sector             ";s1;",";s2:rem goto7260
7070 print"  photon torpedoes   ";int(p):rem goto7260
7120 print"  total energy       ";int(e+s):rem goto7260
7180 print"  shields            ";int(s):rem goto7260
7240 print"  klingons remaining ";int(k9):print
7260 return: rem nexti:printo1$:return
7280 rem library computer code
7290 ifd(8)<0thenprint"computer disabled":goto1990
7320 input"computer active, awaiting command";a:ifa<0then1990
...
7720 nextj:goto7850
7740 z4=i:z5=1:gosub9030:j0=int(10-.5*len(g2$)):printtab(j0);g2$;
7800 z5=5:gosub 9030:j0=int(30-.5*len(g2$)):printtab(j0);g2$;
...
8520 print"starbases in this quadrant.'":goto1990
